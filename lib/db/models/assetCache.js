...
export const AssetPrice = mongoose.models.AssetPrice || mongoose.model('AssetPrice', AssetPriceSchema);
export const HistoricalData = mongoose.models.HistoricalData || mongoose.model('HistoricalData', HistoricalDataSchema);
export const AssetList = mongoose.models.AssetList || mongoose.model('AssetList', AssetListSchema);
export const CryptoDetection = mongoose.models.CryptoDetection || mongoose.model('CryptoDetection', CryptoDetectionSchema);
