        ...
        while (retries < this.maxRetries) {
            try {
                ...
                if (connection.readyState !== ConnectionState.CONNECTED) {
                    ...
                    throw new MongoConnectionError('Database not in connected state');
                }
                return connection;
            }
            catch (error) {
                ...
                if (retries >= this.maxRetries) {
                    ...
                    throw new MongoConnectionError('Persistent connection failure');
                }
                // Wait before retrying
                await new Promise(resolve => setTimeout(resolve, this.retryDelay));
            }
        }
        throw new MongoConnectionError('Unexpected connection failure');
    }
    /**
...
export const mongoDbCacheService = new MongoDbCacheService();
