...
import { AssetCategoryValues } from '../types';
...
class SecureMarketDataService {
    private coinMarketCapRateLimited: boolean;
     ...
     */
    async listAvailableAssets(options: ListOptions = {}) {
    ...
    async getAssetPriceInBTC(symbol: string) {
        try {
            ...
            const mockData = {
                ...
                type: AssetCategoryValues.Crypto
            };
...
export const marketDataService = new SecureMarketDataService();
