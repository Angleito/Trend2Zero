 ...
 */
import { useRef } from 'react'; // Keep useRef for Highcharts instance
...
const HighchartsView = ({ data, // Accept data prop
title, // Accept title prop
symbol, // Keep symbol prop (optional)
theme = 'dark', days = 30, // Keep days prop (optional)
 }) => {
    ...
    return (<HighchartsReact highcharts={Highcharts} options={chartOptions} constructorType={'stockChart'} ref={chartComponentRef} // Attach ref
    />);
};
