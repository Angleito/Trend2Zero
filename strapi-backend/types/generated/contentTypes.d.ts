...
export interface ApiAngleitoAngleito extends Struct.CollectionTypeSchema {
  collectionName: 'angleitos';
  info: {
    description: '';
    displayName: 'Blog Post';
    pluralName: 'angleitos';
    singularName: 'angleito';
  };
  options: {
...
export interface ApiAssetAsset extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volume24h: Schema.Attribute.BigInteger;
  };
}
...
export interface ApiHistoricalDataHistoricalData
  extends Struct.CollectionTypeSchema {
...
export interface ApiMarketOverviewMarketOverview
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::angleito.angleito': ApiAngleitoAngleito;
      'api::asset.asset': ApiAssetAsset;
      'api::blog-post.blog-post': ApiBlogPostBlogPost;
      'api::historical-data.historical-data': ApiHistoricalDataHistoricalData;
      'api::market-overview.market-overview': ApiMarketOverviewMarketOverview;
