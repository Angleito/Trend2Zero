...
(async () => {
  ...
  try {
    ...
    console.log('Navigating to the simple chart test page...');
    await page.goto('http://localhost:3001/test/simple-chart');
    
    // Wait for the page to load
    await page.waitForSelector('h1:has-text("Simple Chart Test")');
    ...
    await page.screenshot({ path: 'simple-chart-test.png' });
