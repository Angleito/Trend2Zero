...
export default function HomePage() {
    ...
    if (!isMounted || loading) {
        return (<div className="min-h-screen flex flex-col" data-testid="home-page-loading">
        <StickyHeader />
        <main className="flex-grow p-6 flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-[#FF9500] mb-4" aria-label="Loading market data"/>
      ...
      <div className="min-h-screen flex flex-col" data-testid="home-page">
        ...
        <main className="flex-grow p-6">
          <div className="container mx-auto max-w-6xl">
            ...
            {popularAssets.length === 0 && (<div className="text-center bg-gray-800 p-8 rounded-lg" data-testid="no-assets-message">
            ...
            {popularAssets.length > 0 && (<AssetPriceTable assets={popularAssets} showCategory={true} data-testid="asset-price-table"/>)}
          </div>
        </main>
      </div>
    </ErrorBoundary>);
