...
const TradingViewLightweightChart = dynamic(() => import('../../../components/TradingViewLightweightChart'), { ssr: false });
export default function ChartDebugPage() {
    ...
    return (<div className="container mx-auto p-4">
      ...
      <div className="mb-4 flex space-x-4">
        <button onClick={handleRerender} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
          Force Re-render
        </button>
        
        <button onClick={() => window.location.reload()} className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">
          Reload Page
        </button>
      </div>
      ...
      <div className="border rounded p-4 mb-4">
        ...
        <div style={{ height: '400px', width: '100%', position: 'relative' }}>
          {mounted && (<TradingViewLightweightChart key={chartKey} data={sampleData} width={800} height={400}/>)}
        </div>
      </div>
      ...
      <div className="border rounded p-4">
        ...
        <div style={{ height: '400px', width: '100%', position: 'relative' }}>
          {mounted && (<TradingViewLightweightChart key={chartKey} symbol="BTC" theme="dark" days={30} width={800} height={400}/>)}
        </div>
      </div>
