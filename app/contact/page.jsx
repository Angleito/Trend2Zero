        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-1">
                    <a href="https://github.com/Angleito" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF9500] transition-colors">
                      github.com/Angleito
                    </a>
                  </p>
                </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-8">
            ...
            <div className="flex justify-center">
              <Link href="/" className="bg-[#FF9500] hover:bg-opacity-90 text-white px-6 py-3 rounded-md transition-colors inline-flex items-center">
