...
describe('Market Data Services', () => {
  describe('Secure Market Data Service Integration', () => {
    let mockService: SecureMarketDataService;
    let mockCoinGeckoService: jest.Mocked<typeof coinGeckoService>;
    let mockCoinMarketCapService: jest.Mocked<typeof coinMarketCapService>;

    beforeEach(() => {
      jest.clearAllMocks();
      
      // Cast the mocks to their proper types
      mockCoinGeckoService = coinGeckoService as jest.Mocked<typeof coinGeckoService>;
    ...
    describe('Asset Price Fetching', () => {
      ...
      it('should handle service failure with fallback', async () => {
        ...
        const mockGeckoResponse: AssetPrice = {
          symbol: 'BTC',
          price: 51000,
          lastUpdated: '2023-01-01T12:00:00Z',
          change: 500,
