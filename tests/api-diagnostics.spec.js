...
test('Comprehensive API Diagnostics', async ({ request }) => {
    ...
    try {
        ...
        console.log('Bitcoin price API request failed with error:', error && typeof error === 'object' && 'message' in error ? error.message : String(error));
    }
    ...
    try {
        ...
        console.log('Environment check request failed with error:', error && typeof error === 'object' && 'message' in error ? error.message : String(error));
    }
    ...
    try {
        ...
        console.log('MongoDB test request failed with error:', error && typeof error === 'object' && 'message' in error ? error.message : String(error));
    }
    ...
    try {
        ...
        console.log('API services test request failed with error:', error && typeof error === 'object' && 'message' in error ? error.message : String(error));
    }
});
